...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "XamarinProjektZaliczeniowy.Android.dll" comes first in this list. */
		"XamarinProjektZaliczeniowy.Android.dll",
		"FormsViewGroup.dll",
		"SQLite-net.dll",
		...
		"XamarinProjektZaliczeniowy.dll",
	};
